...
public class Premium extends JPanel {
	
	public String[] name = {"몬스터X", "통새우X", "기네스와퍼", "기네스머쉬룽와퍼"};
	public int[] price = {9000, 8800, 8400, 8800};
	
	public Premium(Frame f, List list) {
		...
		// 각 메뉴 패널 생성
		ImageIcon img1 = new ImageIcon("./img_whopper/p1.png");
		...
		// 각 메뉴 패널 생성
		ImageIcon img2 = new ImageIcon("./img_whopper/p2.png");
		...
		// 각 메뉴 패널 생성
		ImageIcon img3 = new ImageIcon("./img_whopper/p3.png");
		...
		// 각 메뉴 패널 생성
		ImageIcon img4 = new ImageIcon("./img_whopper/p4.png");
		...
		jp1.addMouseListener(new PanelMouse(name[0], price[0],true, list, f,1));
		jp2.addMouseListener(new PanelMouse(name[1], price[1],true, list, f,1));
		jp3.addMouseListener(new PanelMouse(name[2], price[2],true, list, f,1));
		jp4.addMouseListener(new PanelMouse(name[3], price[3],true, list, f,1));
