...
public class Special extends JPanel {
	...
	public String[] name = {"통새우와퍼X2(행사)", "콰트로치즈와퍼X2(행사)", "치즈와퍼X2(행사)", "통새우와퍼X콰트로치즈와퍼"};
	public int[] price = {8000, 8000, 8000, 8000};
	
	public Special(Frame f, List list) {
		// 그리드 레이아웃 지정
		...
		// 각 메뉴 패널 생성
		ImageIcon img1 = new ImageIcon("./img_whopper/s1.png");
		...
		// 각 메뉴 패널 생성
		ImageIcon img2 = new ImageIcon("./img_whopper/s2.png");
		...
		// 각 메뉴 패널 생성
		ImageIcon img3 = new ImageIcon("./img_whopper/s3.png");
		...
		// 각 메뉴 패널 생성
		ImageIcon img4 = new ImageIcon("./img_whopper/s4.png");
		...
		jp1.addMouseListener(new PanelMouse(name[0], price[0],false, list, f,0));
		jp2.addMouseListener(new PanelMouse(name[1], price[1],false, list, f,0));
		jp3.addMouseListener(new PanelMouse(name[2], price[2],false, list, f,0));
		jp4.addMouseListener(new PanelMouse(name[3], price[3],false, list, f,0));
