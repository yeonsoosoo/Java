...
public class Drink extends JPanel {
	public String[] name = {"버블리", "아메리카노", "선데 아이스크림", "코카콜라"};
	public int[] price = {1500, 1000, 1600, 1900};
	
	public Drink(Frame f, List list) {
		...
		// 각 메뉴 패널 생성
		ImageIcon img1 = new ImageIcon("./img_whopper/d1.png");
		...
		// 각 메뉴 패널 생성
		ImageIcon img2 = new ImageIcon("./img_whopper/d2.png");
		...
		// 각 메뉴 패널 생성
		ImageIcon img3 = new ImageIcon("./img_whopper/d3.png");
		...
		// 각 메뉴 패널 생성
		ImageIcon img4 = new ImageIcon("./img_whopper/d4.png");
		...
		jp1.addMouseListener(new PanelMouse(name[0], price[0],false, list, f,6));
		jp2.addMouseListener(new PanelMouse(name[1], price[1],false, list, f,6));
		jp3.addMouseListener(new PanelMouse(name[2], price[2],false, list, f,6));
		jp4.addMouseListener(new PanelMouse(name[3], price[3],false, list, f,6));
